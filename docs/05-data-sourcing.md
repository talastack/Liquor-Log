...
**963 products**, in `shared/data/spirits.v1.json`, authored by hand in the
...
**None of it is verified.** 0 of 963 rows carry a `source_url`. Each says
...
| **Oregon OLCC** | Socrata dataset `vmf2-f83h`, CSV/JSON, ~263,963 rows, monthly | **Silent.** No terms page; dataset has **no licence field**. The only assertion anywhere is *"All Rights Reserved."* The cleanest bulk source of the three. |
