...
ROWS = [
    ...
    ("johnnie-walker-double-black", "Johnnie Walker", "Johnnie Walker", "Double Black", "blendedScotch", "blend", 40.0, None, [], None),
    ("dewars-12", "Dewar's", "Dewar's", "12 Year", "blendedScotch", "blend", 40.0, 12, [], None),
    ("cutty-sark", "Cutty Sark", "Cutty Sark", "Original", "blendedScotch", "blend", 40.0, None, [], None),
    ("j-and-b-rare", "J&B", "J&B", "Rare", "blendedScotch", "blend", 40.0, None, [], None),
    ("ballantines-finest", "Ballantine's", "Ballantine's", "Finest", "blendedScotch", "blend", 40.0, None, [], None),
    ("grants-triple-wood", "Grant's", "Grant's", "Triple Wood", "blendedScotch", "blend", 40.0, None, [], None),
    ...
    ("keystone-light", "Molson Coors", "Keystone", "Light", "maltBeverage", "unspecified", 4.13, None, [], None),
    ("coors-banquet", "Molson Coors", "Coors", "Banquet", "maltBeverage", "unspecified", 5.0, None, [], None),
    ("modelo-chelada", "Grupo Modelo", "Modelo", "Chelada", "maltBeverage", "unspecified", 3.5, None, [], None),
    ("corona-light", "Grupo Modelo", "Corona", "Light", "maltBeverage", "unspecified", 4.0, None, [], None),
    ("corona-premier", "Grupo Modelo", "Corona", "Premier", "maltBeverage", "unspecified", 4.0, None, [], None),
    ("tecate", "Cuauhtemoc Moctezuma", "Tecate", "Original", "maltBeverage", "unspecified", 4.5, None, [], None),
    ("victoria-lager", "Grupo Modelo", "Victoria", "Lager", "maltBeverage", "unspecified", 4.0, None, [], None),
    ("sapporo-premium", "Sapporo", "Sapporo", "Premium", "maltBeverage", "unspecified", 4.9, None, [], None),
    ("asahi-super-dry", "Asahi", "Asahi", "Super Dry", "maltBeverage", "unspecified", 5.0, None, [], None),
    ("kirin-ichiban", "Kirin", "Kirin", "Ichiban", "maltBeverage", "unspecified", 5.0, None, [], None),
    ("tsingtao", "Tsingtao", "Tsingtao", "Lager", "maltBeverage", "unspecified", 4.7, None, [], None),
    ("peroni-nastro-azzurro", "Peroni", "Peroni", "Nastro Azzurro", "maltBeverage", "unspecified", 5.1, None, [], None),
    ("beck-s", "Beck's", "Beck's", "", "maltBeverage", "unspecified", 5.0, None, [], None),
    ("newcastle-brown-ale", "Newcastle", "Newcastle", "Brown Ale", "maltBeverage", "unspecified", 4.7, None, [], None),
    ("boddingtons-pub-ale", "Boddingtons", "Boddingtons", "Pub Ale", "maltBeverage", "unspecified", 4.6, None, [], None),
    ("bass-pale-ale", "Bass", "Bass", "Pale Ale", "maltBeverage", "unspecified", 5.1, None, [], None),
    ("fullers-london-pride", "Fuller's", "Fuller's", "London Pride", "maltBeverage", "unspecified", 4.7, None, [], None),
    ("sierra-nevada-torpedo", "Sierra Nevada", "Sierra Nevada", "Torpedo Extra IPA", "maltBeverage", "unspecified", 7.2, None, [], None),
    ("stone-arrogant-bastard", "Stone", "Stone", "Arrogant Bastard Ale", "maltBeverage", "unspecified", 7.2, None, [], None),
    ("ballast-point-sculpin", "Ballast Point", "Ballast Point", "Sculpin IPA", "maltBeverage", "unspecified", 7.0, None, [], None),
    ("goose-island-ipa", "Goose Island", "Goose Island", "IPA", "maltBeverage", "unspecified", 5.9, None, [], None),
    ("victory-golden-monkey", "Victory", "Victory", "Golden Monkey", "maltBeverage", "unspecified", 9.5, None, [], None),
    ("ommegang-three-philosophers", "Ommegang", "Ommegang", "Three Philosophers", "maltBeverage", "unspecified", 9.8, None, [], None),
    ("duvel", "Duvel", "Duvel", "", "maltBeverage", "unspecified", 8.5, None, [], None),
    ("chimay-blue", "Chimay", "Chimay", "Blue Grande Reserve", "maltBeverage", "unspecified", 9.0, None, [], None),
    ("orval", "Orval", "Orval", "", "maltBeverage", "unspecified", 6.2, None, [], None),
    ("rochefort-10", "Rochefort", "Rochefort", "10", "maltBeverage", "unspecified", 11.3, None, [], None),
    ("westmalle-tripel", "Westmalle", "Westmalle", "Tripel", "maltBeverage", "unspecified", 9.5, None, [], None),
    ("la-fin-du-monde", "Unibroue", "Unibroue", "La Fin du Monde", "maltBeverage", "unspecified", 9.0, None, [], None),
    ("weihenstephaner-hefeweissbier", "Weihenstephaner", "Weihenstephaner", "Hefeweissbier", "maltBeverage", "unspecified", 5.4, None, [], None),
    ("paulaner-hefe-weizen", "Paulaner", "Paulaner", "Hefe-Weizen", "maltBeverage", "unspecified", 5.5, None, [], None),
    ("spaten-oktoberfest", "Spaten", "Spaten", "Oktoberfest", "maltBeverage", "unspecified", 5.9, None, [], None),
    ("ayinger-celebrator", "Ayinger", "Ayinger", "Celebrator Doppelbock", "maltBeverage", "unspecified", 6.7, None, [], None),
