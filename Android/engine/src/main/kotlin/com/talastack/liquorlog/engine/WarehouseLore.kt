 ...
 */
object WarehouseLore {

    data class Note(val text: String, val source: String)
     ...
     */
    fun note(distillery: String, warehouse: String?): Note? {
        val d = distillery.normalizedForMatching()
        val w = (warehouse ?: "").normalizedForMatching()
